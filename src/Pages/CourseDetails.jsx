...
import CourseAccordionBar from '../components/core/Cousre/CourseAccordionBar';
import CourseDetailsCard from '../components/core/Cousre/CourseDetailsCard';
...
const CourseDetails = () => {
    ...
    useEffect(()=>{
        ...
        response?.data?.courseDetails?.courseContent?.forEach((sec) => {
            lectures += sec.subSection.lenght || 0
        })
