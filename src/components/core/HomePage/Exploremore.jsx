  ...
  return (
    <div className=''>
      ...
      <div className='hidden lg:block lg:h-[200px]'>
        ...
        <div className='lg:absolute gap-10 justify-center lg:gap-0 flex lg:justify-between flex-wrap w-full lg:bottom-0 lg:left-[50%] lg:translate-x-[-50%] lg:translate-y-[50%] text-black lg:mb-0 mb-7'>
            {
