...
const ForgotPassword = () => {
  ...
  return (
    <div className='grid noorifati05@gmail.com place-items-center'>
      {
        loading ? (
            <div className='spinner'> Loading...</div>
        ):(
            <div className='max-w-[500px] p-4 lg:p-8'>
                <h1 className='text-[1.875rem] font-semibold leading-[1.625rem] text-richblack-100'>
                    {
                        ...
                        !emailSent && (
                            <label className='w-full'>
                                ...
                                <input 
                                   ...
                                   className='form-style w-full py-1 px-1 rounded-sm'
                                   />
                            </label>
                        )
                    }
