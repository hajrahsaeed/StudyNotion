...
import { Table, Tr, Td, Tbody, Thead, Th } from 'react-super-responsive-table';
        ...
        <Tbody>
            {
                courses.lengh === 0 ? (
                    ...
                    courses.map((course) => (
                        <Tr key={course._id} className="flex gap-x-10 border-b border-richblack-800 px-6 p-8">
                            <Td className="flex flex-1 gap-x-4">
                                <img src={course?.thumbnail} alt='thumbnail'
                                  className='h-[150px] w-[230px] rounded-lg object-cover' 
                                />
                                ...
                                <button disabled ={loading}
                                  onClick={() => {
                                    setConfirmationModa({
                                        ...
                                        btn2Handler:!loading ? () => setConfirmationModa(null): () => {},
                                    })
                                  }}
                                  title="Delete"
